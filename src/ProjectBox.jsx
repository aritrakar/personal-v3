        ...
        <div className="flex justify-center text-left p-4">
            ...
            <div className="p-6 flex flex-col justify-start bg-slate-200">
                ...
                <div className="w-[7vw] h-[4vh] flex flex-row justify-between">
                    {(props.demo != "") && (
                        <a href={props.demo} target="_blank" rel="noopener noreferrer" className="text-gray-700 text-base mb-4 p-0 m-0 no-underline hover:underline">Demo</a>
                    )}
                    {(props.github != "") && (
                        <a href={props.github} target="_blank" rel="noopener noreferrer" className="text-gray-700 text-base mb-4 p-0 m-0 no-underline hover:underline">GitHub</a>
                    )}
                </div>
